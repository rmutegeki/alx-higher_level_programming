# Import & modules
Project done during **ALX's Full Stack Software Engineering Program**. It aims to learn how to import functions, how to create modules and how to use command line arguments in **Python**.

## Technologies
* Shell Scripts are written in Bash 4.3.11(1)
* Python Scripts are written with Python 3.8.13
...
| `2-args.py` | Prints the number of and the list of itthe addition of all arguments |
